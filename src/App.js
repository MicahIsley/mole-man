...
import minmin from './assets/minmin.jpg';
...
const gameData = [
   [
    ...
    {name: "Micah", character: minmin, kos: 4},
    {name: "Tim", character: pacman, kos: 2},
    {name: "Zack", character: corrin, kos: 2},
    {name: "", character: empty, kos: 0},
    ...
    {name: "Zack", character: kirby, kos: 3},
    {name: "Ness", character: ness, kos: 3},
    {name: "Micah", character: wiifittrainer, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Corneria"},
    {date: new Date(2020,6,15)}
  ],[
    ...
    {name: "Micah", character: diddykong, kos: 4},
    {name: "Zack", character: kingdedede, kos: 3},
    {name: "Tim", character: younglink, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Custom"},
    {date: new Date(2020,6,15)}
  ],[
    {name: "Zack", character: drmario, kos: 5},
    {name: "Tim", character: ness, kos: 3},
    {name: "Micah", character: marth, kos: 0},
    {name: "", character: empty, kos: 0},
    {stage: "Custom"},
    {date: new Date(2020,6,15)}
  ],[
    ...
    {name: "Zack", character: pirahnaplant, kos: 4},
    {name: "Betsy", character: villager, kos: 4},
    {name: "Tim", character: miiswordfighter, kos: 0},
    {name: "", character: empty, kos: 0},
    {stage: "Mario Galaxy"},
    ...
    {name: "Tim", character: luigi, kos: 3},
    {name: "Micah", character: minmin, kos: 3},
    {name: "Zack", character: hero, kos: 2},
    {name: "", character: empty, kos: 0},
    {stage: "Spring Stadium"},
    ...
    {name: "Micah", character: darkpit, kos: 2},
    {name: "", character: empty, kos: 0},
    {stage: "Balloon Fight"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Micah", character: bowserjr, kos: 4},
    {name: "Zack", character: yoshi, kos: 3},
    {name: "Tim", character: donkeykong, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Custom"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Zack", character: yoshi, kos: 3},
    {name: "Tim", character: sonic, kos: 2},
    {name: "Micah", character: lucario, kos: 3},
    {name: "", character: empty, kos: 0},
    {stage: "Custom"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Zack", character: drmario, kos: 6},
    {name: "Tim", character: olimar, kos: 0},
    {name: "Micah", character: palutena, kos: 2},
    {name: "", character: empty, kos: 0},
    {stage: "Green Greens"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Tim", character: rosalina, kos: 4},
    {name: "Zack", character: kirby, kos: 3},
    {name: "Micah", character: incineroar, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Battlefield"},
    ...
    {name: "Zack", character: ridley, kos: 4},
    {name: "Micah", character: wiifittrainer, kos: 4},
    {name: "Tim", character: ken, kos: 0},
    {name: "", character: empty, kos: 0},
    {stage: "Wario Ware"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Zack", character: lucas, kos: 2},
    {name: "Tim", character: pit, kos: 3},
    {name: "Micah", character: minmin, kos: 3},
    {name: "", character: empty, kos: 0},
    {stage: "Duck Hunt"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Tim", character: pikachu, kos: 6},
    {name: "Zack", character: pokemontrainer, kos: 1},
    {name: "Micah", character: minmin, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Princess Peach's Castle"},
    {date: new Date(2020,6,21)}
  ],[
    {name: "Tim", character: mario, kos: 2},
    {name: "Zack", character: pokemontrainer, kos: 4},
    {name: "Micah", character: iceclimbers, kos: 2},
    {name: "", character: empty, kos: 0},
    {stage: "Final Destination"},
    ...
    {name: "Micah", character: minmin, kos: 2},
    {name: "Zack", character: corrin, kos: 3},
    {name: "Tim", character: littlemac, kos: 2},
    {name: "", character: empty, kos: 0},
    {stage: "Town and City"},
    {date: new Date(2020,6,21)}
  ],[
    ...
    {name: "Tim", character: ness, kos:2},
    {name: "Doug", character: marth, kos:2},
    {name: "Micah", character: roy, kos:2},
    {name: "", character: empty, kos:0},
    {stage: "Town and City"},
    {date: new Date(2020,7,6)}
  ],[
    {name: "Micah", character: terry, kos:5},
    {name: "Tim", character: ness, kos:1},
    {name: "Doug", character: link, kos:1},
    {name: "", character: empty, kos: 0},
    {stage: ""},
    {date: new Date(2020,7,6)}
  ],[
    {name: "Micah", character: bowserjr, kos:6},
    {name: "Doug", character: link, kos:1},
    {name: "Tim", character: pacman, kos:1},
    {name: "", character: empty, kos:0},
    {stage: "Custom"},
    ...
    {name: "Doug", character: kirby, kos:5},
    {name: "Micah", character: minmin, kos:1},
    {name: "Tim", character: miiswordfighter, kos:2},
    {name: "", character: empty, kos:0},
    {stage: ""},
    ...
    {name: "Micah", character: isabell, kos:3},
    {name: "Tim", character: ridley, kos:4},
    {name: "Doug", character: donkeykong, kos:1},
    {name: "", character: empty, kos:0},
    {stage: "Big Battlefield"},
    {date: new Date(2020,7,6)}
  ],[
    {name: "Micah", character: wiifittrainer, kos:4},
    {name: "Tim", character: ness, kos:1},
    {name: "Doug", character: marth, kos:3},
    {name: "", character: empty, kos:0},
    {stage: "Peach's Castle"},
    {date: new Date(2020,7,6)}
  ],[
    {name: "Micah", character: wiifittrainer, kos: 5},
    {name: "Tim", character: pacman, kos: 0},
    {name: "Zack", character: miiswordfighter, kos: 5},
    {name: "Doug", character: link, kos: 0},
    {stage: "Super Happy Tree"},
    {date: new Date(2020,7,13)}
  ],[
    {name: "Tim", character: samus, kos: 4},
    {name: "Zack", character: miigunner, kos: 1},
    {name: "Doug", character: incineroar, kos: 3},
    {name: "Micah", character: minmin, kos: 1},
    {stage: "Green Greens"},
    {date: new Date(2020,7,13)}
  ],[
    {name: "Tim", character: pacman, kos: 3},
    {name: "Zack", character: miiswordfighter, kos: 2},
    {name: "Micah", character: darkpit, kos: 2},
    {name: "Doug", character: diddykong, kos: 4},
    {stage: "Battlefield"},
    {date: new Date(2020,7,13)}
  ],[
    {name: "Micah", character: olimar, kos: 5},
    {name: "Tim", character: darksamus, kos: 3},
    {name: "Doug", character: samus, kos: 0},
    {name: "Zack", character: ridley, kos: 3},
    {stage: "Hanenbow"},
    {date: new Date(2020,7,13)}
  ],[
    {name: "Zack", character: ridley, kos: 4},
    {name: "Doug", character: samus, kos: 2},
    {name: "Mich", character: bowserjr, kos: 3},
    {name: "Tim", character: miiswordfighter, kos: 1},
    {stage: "Wily Castle"},
    {date: new Date(2020,7,13)}
  ],[
    ...
    {name: "Zack", character: kirby, kos: 6},
    {name: "Tim", character: ness, kos: 2},
    {name: "Micah", character: inkling, kos: 1},
    {name: "Doug", character: jigglypuff, kos: 1},
    {stage: "Spring Stadium"},
    {date: new Date(2020,7,13)}
  ],[
    ...
    {name: "Tim", character: ness, kos: 4},
    {name: "Micah", character: peach, kos: 5},
    {name: "Zack", character: drmario, kos: 2},
    {name: "Doug", character: marth, kos: 0},
    {stage: "Pac-Land"},
    {date: new Date(2020,7,13)}
    ...
    {name: "Tim", character: ness, kos: 5},
    {name: "Doug", character: marth, kos: 3},
    {name: "Micah", character: robin, kos: 0},
    {name: "", character: empty, kos: 0},
    {stage: "Corneria"},
    ...
    {name: "Micah", character: isabell, kos: 3},
    {name: "Doug", character: incineroar, kos: 2},
    {name: "Tim", character: chrom, kos: 0},
    {name: "", character: empty, kos: 0},
    {stage: "Battlefield"},
    {date: new Date(2020,7,19)}
  ],[
    ...
    {name: "Micah", character: bowserjr, kos: 3},
    {name: "Tim", character: pacman, kos: 4},
    {name: "Doug", character: luigi, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Tortimer Island"},
    {date: new Date(2020,7,19)}
  ],[
    ...
    {name: "Micah", character: peach, kos: 4},
    {name: "Tim", character: ridley, kos: 2},
    {name: "Doug", character: gameandwatch, kos: 2},
    {name: "", character: empty, kos: 0},
    {stage: "Spirt Train"},
    {date: new Date(2020,8,16)}
  ],[
    ...
    {name: "Zack", character: pokemontrainer, kos: 6},
    {name: "Doug", character: samus, kos: 1},
    {name: "Tim", character: miiswordfighter, kos: 2},
    {name: "Micah", character: incineroar, kos: 2},
    {stage: "Spirit Train"},
    ...
    {name: "Tim", character: ness, kos: 2},
    {name: "Zack", character: corrin, kos: 6},
    {name: "Doug", character: duckhunt, kos: 1},
    {name: "Micah", character: darkpit, kos: 2},
    {stage: "Mairo Galaxy"},
    {date: new Date(2020,8,16)}
  ],[
    {name: "Zack", character: duckhunt, kos: 3},
    {name: "Tim", character: duckhunt, kos: 1},
    {name: "Micah", character: terry, kos: 4},
    {name: "Doug", character: donkeykong, kos: 3},
    {stage: "Battlefield"},
    {date: new Date(2020,8,16)}
  ],[
    {name: "Tim", character: ness, kos:5 },
    {name: "Doug", character: captainfalcon, kos: 2},
    {name: "Micah", character: peach, kos: 2},
    {name: "Zack", character: ridley, kos: 2},
    {stage: "Tomodachi Life"},
    {date: new Date(2020,8,16)}
  ],[
    {name: "Zack", character: corrin, kos: 5},
    {name: "Micah", character: minmin, kos: 3},
    {name: "Tim", character: luigi, kos: 0},
    {name: "", character: empty, kos: 0},
    {stage: "Delfino Plaza"},
    ...
    {name: "Micah", character: wiifittrainer, kos: 5},
    {name: "Zack", character: pirahnaplant, kos: 2},
    {name: "Tim", character: darksamus, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Battlefield"},
    {date: new Date(2020,8,24)}
    ...
    {name: "Zack", character: miiswordfighter, kos: 3},
    {name: "Tim", character: ness, kos: 4},
    {name: "Micah", character: peach, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Rainbow Cruise"},
    ...
    {name: "Micah", character: wiifittrainer, kos: 3},
    {name: "Tim", character: ness, kos: 5},
    {name: "Zack", character: miibrawler, kos: 0},
    {name: "", character: empty, kos: 0},
    ...
    {name: "Zack", character: miigunner, kos: 4},
    {name: "Tim", character: miiswordfighter, kos: 3},
    {name: "Micah", character: diddykong, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "Battlefield"},
    ...
    {name: "Zack", character: corrin, kos: 5},
    {name: "Micah", character: isabell, kos: 2},
    {name: "Tim", character: darksamus, kos: 1},
    {name: "", character: empty, kos: 0},
    {stage: "3D Land"},
    {date: new Date(2020,9,1)}
    ...
    {name: "Zack", character: pirahnaplant, kos: 4},
    {name: "Micah", character: darkpit, kos: 1},
    {name: "Tim", character: younglink, kos: 3},
    {name: "", character: empty, kos: 0},
    {stage: "Prism Tower"},
    {date: new Date(2020,9,1)}
  ],[
     ...
     return (
        <div className="col-xs-12">
            ...
            <div className="row">
                ...
                <div className="col-xs-3 overallCol">
                    <div className="row overallTitle">Least Played</div>
                    <div className="row">
